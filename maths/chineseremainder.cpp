...
//how do you solve if there are n values run a loop for i from 1 to n-1 where put a1 and m1 as arr[0] and m[0] .
//if at any point m =-1 then there is no solution
